...
namespace BVS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            {
                Text = "Doctor",
                Value = ((int)UserType.Doctor).ToString()
            };
            viewModel.UserTypes = new List<SelectListItem>();
            viewModel.UserTypes.Add( doctor );
            viewModel.UserTypes.Add( admin );
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if ( ModelState.IsValid )
            {
                BusinessServiceOperationResult result = new BusinessServiceOperationResult();
                ...
                using ( var transaction = new TransactionScope() )
                {
                    ...
                    {
                        var roleString = "Doctor";
                        if ( model.UserTypeID == (int)UserType.Admin )
                        {
                            roleString = "Admin";
                        }
                        identityResult = userManager.AddToRole( user.Id, roleString );
                        if ( !identityResult.Succeeded )
                        {
            ...
            model.UserTypes.Add( doctor );
            model.UserTypes.Add( admin );
            return View( model );
        }
